...
const Updatebooks = () => {
  ...
  const fetchBook = useCallback(async () => {
    try {
      const response = await fetch(
        `${config.apiBaseUrl}/fullmarks-server/Masterfilter/Book/getBook.php?book_id=${decodedId}`
      );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(
        `${config.apiBaseUrl}/fullmarks-server/Masterfilter/Book/updatebooks.php`,
        {
          method: "POST",
          body: formData,
        }
      ...
      >
        <div className="row">
          <div className="col-md-12">
            <div className="text-grey fw-bold h4">Update Book</div>
            <hr />
            <form onSubmit={handleSubmit}>
              ...
              <label className="fw-bold">
                Book Code<span className="text-danger">*</span>
              </label>
              <br />
              <input
                className="custom-input  cursor"
              ...
              <label className="fw-bold">Book Download Link</label>
              <br />
              <input
                className="custom-input  cursor"
              ...
              <label className="fw-bold">TPG Download Link</label>
              <br />
              <input
                className="custom-input  cursor"
              ...
              <label className="fw-bold">Book Description</label>
              <br />
              <textarea
                className="custom-input  cursor"
              ...
              <br />
              <br />
              <label className="fw-bold">Book Cover </label>

              <br />
              {existingBookCover && (
                <div>
                  <img
                    src={`${config.apiBaseUrl}/fullmarks-server/uploads/book_cover/${existingBookCover}`}
                    alt="Page Image"
                    style={{ width: "50px" }}
                  />
                </div>
