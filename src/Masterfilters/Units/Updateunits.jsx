...
const Updateunits = () => {
  ...
  const fetchUnit = async () => {
    try {
      const response = await fetch(
        `${config.apiBaseUrl}/fullmarks-server/Masterfilter/Units/getUnit.php?unit_id=${decodedId}`
      );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        `${config.apiBaseUrl}/fullmarks-server/Masterfilter/Units/updateunit.php?unit_id=${decodedId}`,
        {
          method: "POST",
          headers: {
        ...
        >
          <div className="row">
            <div className="col-md-12">
              <div className="text-grey fw-bold h4">Update Unit</div>
              <hr></hr>
