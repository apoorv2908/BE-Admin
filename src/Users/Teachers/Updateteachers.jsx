...
const Updateteachers = () => {
  ...
  const fetchTeacherDetails = async () => {
    try {
      const response = await fetch(
        `${config.apiBaseUrl}/fullmarks-server/Users/Teachers/getteachers.php?teacher_id=${decodedId}`
      );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        `${config.apiBaseUrl}/fullmarks-server/Users/Teachers/updateteachers.php`,
        {
          method: "POST",
          body: formData,
        }
            ...
            <form onSubmit={handleSubmit} encType="multipart/form-data">
              ...
              {profilePicURL && (
                <div className="position-relative">
                  <img
                    src={`${config.apiBaseUrl}/fullmarks-server/uploads/teachers/${profilePicURL}`}
                    alt="Profile"
                    className="img-fluid"
